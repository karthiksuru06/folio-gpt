    ...
    <ArticleLayout>
      ...
      <article className="prose-custom">
        ...
        <Photo1
          ...
          alt={'foliogpt.com homepage'}
          width={1406} height={1345}
          caption={'foliogpt.com: homepage generated with Astro SSG. Device search, categories and brands.'}
        />
        ...
        <Photo1
          ...
          alt={'Samsung category page on foliogpt.com'}
        ...
        <Photo1
          ...
          alt={'Repair page hero on foliogpt.com'}
          width={1440} height={900}
        ...
        <Photo2
          items={[
            { src: '/pseo/ss-squarespace-mobile.webp', alt: 'foliogpt.me on Squarespace: mobile homepage', width: 800, height: 1422 },
            { src: '/pseo/ss-squarespace-pricing.webp', alt: 'foliogpt.me on Squarespace: pricing page with generic icons', width: 800, height: 1422 },
          ]}
          caption={'foliogpt.me on Squarespace. Homepage and pricing page: generic icons, no real photos, no ERP data.'}
        />
        ...
        <Photo1
          ...
          alt={'SISTRIX: organic visibility of foliogpt.me in constant decline from 2019 to 2024'}
        ...
        <Photo2
          items={[
            ...
            { src: '/pseo/ss-audit-sector.webp', alt: 'SISTRIX: sector visibility comparison in Spain — foliogpt.me invisible vs competitors', width: 2000, height: 1125 },
          ]}
          caption={'Left: GSC shows clicks halving (17.3K clicks, avg position 23.1). Right: sector comparison — foliogpt.me is the red line stuck to the X axis.'}
        />
        ...
        <DiagramZoom
          ...
          caption={<>After: Astro + Cloudflare. Lighthouse 97/100 mobile. CWV passed. <a href="https://pagespeed.web.dev/analysis/https-foliogptirepair-es/rynn9cjrrs?form_factor=mobile" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Check it yourself →</a></>}
        />
        ...
        <DiagramZoom
          ...
          alt={'AHREFs sector comparison: foliogpt.me with DR 0.1 and 23 backlinks vs competitors with thousands'}
          width={2000} height={1125} hdWidth={3000} hdHeight={1688}
          caption={'Domain strength comparison (AHREFs). foliogpt.me: DR 0.1, 23 backlinks. Sector leader (iriparo.com): DR 44, 21,430 backlinks.'}
        />
      ...
      <ArticleFooter utmCampaign="pseo" />
    </ArticleLayout>
  )
}
