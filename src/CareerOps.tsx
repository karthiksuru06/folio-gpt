...
export default function CareerOps({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://foliogpt.com/career-ops/og-career-ops.webp',
  ...
  return (
    <ArticleLayout>
      ...
      <Manifesto cite="https://foliogpt.com/career-ops">{t.manifesto}</Manifesto>
      ...
      <GitHubRepoBadge repo="foliogpt/career-ops" stars="43.8K" forks="9.2K" />
      ...
      <ArticleFooter utmCampaign="career-ops" />
    </ArticleLayout>
  )
}
