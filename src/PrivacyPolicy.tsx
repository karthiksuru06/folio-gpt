  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          'Los mensajes del chatbot se utilizan exclusivamente para generar respuestas contextuales sobre la experiencia profesional de Karthik.',
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          "Chatbot messages are used exclusively to generate contextual responses about Karthik's professional experience.",
