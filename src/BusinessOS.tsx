  ...
  return (
    <ArticleLayout>
      ...
      <Photo2
        ...
        items={[
          { src: '/business-os/hero-storefront.webp', alt: 'Folio-GPT storefront — phone repair shop in Madrid', width: 900, height: 1200 },
          { src: '/business-os/hero-storefront-urban.webp', alt: 'Folio-GPT at night — urban view with the shop lit up', width: 800, height: 1067 },
        ]}
        className="mb-8"
      />
      ...
      <article className="prose-custom">
        ...
        <Photo2
          ...
          items={[
            { src: '/business-os/counter-organized-front.webp', alt: 'Folio-GPT interior — what the customer sees walking in: counter with iMac, logo and spherical lamp', width: 360, height: 480 },
            { src: '/business-os/after-elevator-lamp.webp', alt: 'Wooden dumbwaiter next to spherical lamp and Folio-GPT logo — connection between counter and workshop', width: 360, height: 480 },
          ]}
            ...
            <div key={flow.name} className="scroll-mt-20">
              ...
              {idx === 0 && (
                <Photo2 editorId="repair-counter-watch"
                  items={[
                    { src: '/business-os/after-counter-pov.webp', alt: 'Folio-GPT counter from employee POV — iMac with Airtable open, appointments scheduled', width: 800, height: 1067 },
        ...
        <CaseStudyCta
          ...
          ctaHref={'mailto:hi@foliogpt.com?subject=Programmatic SEO'}
        />
        ...
        <Photo2
          ...
          items={[
            ...
            { src: '/business-os/before-founder-overwhelmed.webp', alt: 'Karthik in the workshop', width: 600, height: 800 },
          ]}
        ...
        <Photo2
          ...
          items={[
            { src: '/business-os/after-store-interior.webp', alt: 'Folio-GPT interior', width: 1200, height: 900 },
      ...
      <ArticleFooter utmCampaign="business-os" />
    </ArticleLayout>
  )
}
