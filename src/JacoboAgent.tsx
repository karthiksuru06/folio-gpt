...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://foliogpt.com/jacobo/og-jacobo-agent.webp',
  ...
  return (
    <ArticleLayout >
      <FloatingToc />
      <ArticleHeader editorId="hero-header"  kicker={t.header.kicker} h1={t.header.h1} subtitle={t.header.subtitle} date={t.header.date} dateISO="2026-02-25" dateModifiedISO="2026-05-10" readingTime={t.readingTime} />
      ...
      <GitHubRepoBadge repo="foliogpt/jacobo-workflows" stars="135" forks="44"  />
      ...
      <Photo2 editorId="hero-photos" items={[
        { src: '/jacobo/santiago-headphones-thinking.webp', alt: 'Karthik Suru', loading: 'eager', width: 360, height: 480 },
        { src: '/jacobo/shop-microsoldering-station.webp', alt: 'Microsoldering station at Folio-GPT', loading: 'eager', width: 540, height: 720 },
      ...
      <article className="prose-custom">
        ...
        <Photo2 editorId="problem-shop-counter" items={[
          { src: '/jacobo/shop-counter-smart-displays.webp', alt: 'Folio-GPT counter with smart displays', width: 1024, height: 768 },
        ...
        <ScreenshotGrid editorId="email-formal-flow"  items={[
          ...
          { src: 'email-formal-3.webp', altEs: 'Firma: "Un saludo, Jacobo — Folio-GPT — dirección + teléfono + email"', altEn: 'Signature: "Best regards, Jacobo — Folio-GPT — address + phone + email"', width: 1170, height: 2532 },
        ]} />
        ...
        <InlineWorkflowDownload href={wfById['calculadora-foliogpt'].href} label={t.downloads.inlineLabel} fileSize={wfById['calculadora-foliogpt'].fileSize} />
      ...
      <ArticleFooter  utmCampaign="jacobo" />
    </ArticleLayout>
  )
}
