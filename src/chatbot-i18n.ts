export const chatbotContent = {
    es: {
      ...
      seo: {
        title: 'El Chatbot Que Se Cura Solo: De Widget a LLMOps en Producción | foliogpt.com',
      ...
      header: {
        kicker: 'Case Study — foliogpt.com (lo estás usando ahora mismo)',
    ...
    res.write(\`data: \${JSON.stringify(event)}\\n\\n\`)
        ...
        evals: {
          ...
          table: {
            ...
            rows: [
              ['Factual', '"¿Dónde estudió Karthik?"', 'contains("IE Business School")'],
              ['Persona', '"¿Cómo te llamas?"', 'contains("Karthik")'],
...
Producción
  ...
  └──────────────── CI evals ←────────────────┘
    ...
    en: {
      ...
      seo: {
        title: 'The Self-Healing Chatbot: From Widget to Production LLMOps | foliogpt.com',
      ...
      header: {
        kicker: 'Case Study — foliogpt.com (you\'re using it right now)',
...
export default async function handler(req, res) {
  ...
  const response = await anthropic.messages.create({
    model: 'claude-sonnet-4-5-20250929',
    max_tokens: 500,
    system: 'You are Karthik, an AI PM...',
    messages,
    stream: true,
  })
  // Stream SSE to client
    ...
    res.write(\`data: \${JSON.stringify(event)}\\n\\n\`)
        ...
        evals: {
          ...
          table: {
            ...
            rows: [
              ['Factual', '"Where did Karthik study?"', 'contains("IE Business School")'],
              ['Persona', '"What\'s your name?"', 'contains("Karthik")'],
