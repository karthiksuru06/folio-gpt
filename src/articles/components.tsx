  ...
  return (
    <footer className="mt-16 pt-8 border-t border-border">
      ...
      <div className="flex gap-3 mb-8">
        ...
        <a href="https://github.com/karthiksuru06" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors">
